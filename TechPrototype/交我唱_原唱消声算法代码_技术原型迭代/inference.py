...
def main():
    ...
    p.add_argument('--sr', '-r', type=int, default=22050)#44100)
    p.add_argument('--n_fft', '-f', type=int, default=1024)#2048)
    p.add_argument('--hop_length', '-l', type=int, default=512)#1024)
